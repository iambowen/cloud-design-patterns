...
* [缓存模式(Cache-Aside)](patterns/cache-aside.md)
...
* [领导者选举模式(Leader Election)](patterns/leader-election.md)
...
* [调度者、代理、管理者模式(Scheduler Agent Supervisor)](patterns/scheduler-agent-supervisor.md)
...
* [代客密钥模式(Valet Key)](patterns/valet-key.md)